function [nodez,nodezinpoly,nodegrid,edgez]=creategraph(nodez,nodepoly,nodezinpoly,edgez,rdpolynum,nodeconfig,range)
...
for i=polynum-rdpolynum+1:polynum % random ploytope
    for j=1:polynum-rdpolynum % exist ploytope
        [viaz,fg] = formationP2z([nodepoly(i),nodepoly(j)],[nodez(nodezinpoly{i}(1),1:2),nodeconfig],range);
        if fg==1
